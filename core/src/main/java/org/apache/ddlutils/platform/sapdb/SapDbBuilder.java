...
public class SapDbBuilder extends SqlBuilder {
	 ...
	 * @param isRequired
	 *            Whether the column shall be required
	 */
	public void changeColumnRequiredStatus(Table table, Column column,
	 ...
	 */
	public void changeColumnDefaultValue(Table table, Column column,
			String newDefaultValue) throws IOException {
		print("ALTER TABLE ");
		printlnIdentifier(getTableName(table));
		printIndent();
		print("COLUMN ");
	...
	protected void writeCastExpression(Column sourceColumn, Column targetColumn)
			throws IOException {
		boolean charSizeChanged = TypeMap
				.isTextType(targetColumn.getTypeCode())
