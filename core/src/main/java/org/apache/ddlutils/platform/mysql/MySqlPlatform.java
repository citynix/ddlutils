...
public class MySqlPlatform extends PlatformImplBase {
	...
	public MySqlPlatform() {
		...
		info.addNativeTypeMapping(Types.DATALINK, "MEDIUMBLOB",
				Types.LONGVARBINARY);
	...
	protected ModelComparator getModelComparator() {
		return new MySqlModelComparator(getPlatformInfo(),
	...
	public void processChange(Database currentModel, CreationParameters params,
		...
		if (change.getPreviousColumn() != null) {
			prevColumn = changedTable.findColumn(change.getPreviousColumn(),
					isDelimitedIdentifierModeOn());
		}
		((MySqlBuilder) getSqlBuilder()).insertColumn(changedTable,
				change.getNewColumn(), prevColumn);
	...
	public void processChange(Database currentModel, CreationParameters params,
		...
		((MySqlBuilder) getSqlBuilder()).recreateColumn(changedTable,
				change.getNewColumn());
	}
