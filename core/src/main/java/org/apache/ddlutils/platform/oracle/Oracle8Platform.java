...
public class Oracle8Platform extends PlatformImplBase {
		...
		return new DefaultTableDefinitionChangesPredicate() {
			protected boolean isSupported(Table intermediateTable,
				...
				if ((change instanceof AddPrimaryKeyChange)
					...
					// TODO: for now we trigger recreating the table, but
					// ideally we should simply add the necessary pk changes
	...
	public void processChange(Database currentModel, CreationParameters params,
		...
		((Oracle8Builder) getSqlBuilder()).dropColumn(changedTable,
				removedColumn);
