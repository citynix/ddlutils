...
public class Db2Platform extends PlatformImplBase {
	...
	public Db2Platform() {
		...
		info.setSupportedOnUpdateActions(new CascadeActionEnum[]{
				CascadeActionEnum.RESTRICT, CascadeActionEnum.NONE});
		info.setSupportedOnDeleteActions(new CascadeActionEnum[]{
				CascadeActionEnum.RESTRICT, CascadeActionEnum.CASCADE,
		...
		return new DefaultTableDefinitionChangesPredicate() {
			protected boolean isSupported(Table intermediateTable,
				...
				if ((change instanceof RemoveColumnChange)
					...
					// DB2 cannot add IDENTITY columns, and required columns
