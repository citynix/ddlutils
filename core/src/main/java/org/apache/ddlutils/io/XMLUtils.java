 ...
 * </p>
 * Parts of this class are borrowed from <a
 * href='http://commons.apache.org/betwixt/'>Apache Commons Betwixt</a> whose
 * class in turn is based on code in <a
 * href='http://xerces.apache.org/xerces2-j/index.html'>Apache Xerces</a>.
 * <p>
 * The code for {@link #isWellFormedXMLName} is based on code in
 * <code>org.apache.xerces.util.XMLChar</code> in <a
 * href='http://xerces.apache.org/xerces2-j/index.html'>Apache Xerces</a>. The
 * authors of the Xerces and Betwixt classes are credited below.
 * </p>
 * 
...
public class XMLUtils {
	...
	/**
	 * <p>
	 * Determines whether the given string is a well formed xml name. Only
	 * certain characters are allowed in well formed element and attribute names
	 * in xml. For example, white space is not allowed in a name.
	 * </p>
	 * 
	 * <p>
	 ...
	 * 
	 * @param name
	 *            The string to be checked for use as an xml attribute or
	 *            element name. Returns <code>false</code> if <code>name</code>
	 *            is null
	 ...
	 * defined by the XML 1.0 specification.
	 * 
	 * @param c
	 ...
	 * as defined in the XML 1.0 specification.
	 * 
	 * @param c
	 *            The character to check
	...
	public static String base64Encode(String value) {
		try {
			return value == null ? null : new String(Base64.encodeBase64(value
	 ...
	 * @param text
	 *            The text
	 * @return <code>null</code> if the text contains special characters, or the
	 *         list of cut points otherwise
	 */
