...
public class DatabaseIO {
	...
	public static final QName QNAME_ELEMENT_COLUMN = new QName(
			DDLUTILS_NAMESPACE, "column");
	/** Qualified name of the database element. */
	public static final QName QNAME_ELEMENT_DATABASE = new QName(
			DDLUTILS_NAMESPACE, "database");
	/** Qualified name of the foreign-key element. */
	public static final QName QNAME_ELEMENT_FOREIGN_KEY = new QName(
			DDLUTILS_NAMESPACE, "foreign-key");
	/** Qualified name of the index element. */
	public static final QName QNAME_ELEMENT_INDEX = new QName(
			DDLUTILS_NAMESPACE, "index");
	/** Qualified name of the index-column element. */
	public static final QName QNAME_ELEMENT_INDEX_COLUMN = new QName(
			DDLUTILS_NAMESPACE, "index-column");
	/** Qualified name of the reference element. */
	public static final QName QNAME_ELEMENT_REFERENCE = new QName(
			DDLUTILS_NAMESPACE, "reference");
	/** Qualified name of the table element. */
	public static final QName QNAME_ELEMENT_TABLE = new QName(
			DDLUTILS_NAMESPACE, "table");
	/** Qualified name of the unique element. */
	public static final QName QNAME_ELEMENT_UNIQUE = new QName(
			DDLUTILS_NAMESPACE, "unique");
	/** Qualified name of the unique-column element. */
	public static final QName QNAME_ELEMENT_UNIQUE_COLUMN = new QName(
			DDLUTILS_NAMESPACE, "unique-column");

	/** Qualified name of the autoIncrement attribute. */
	public static final QName QNAME_ATTRIBUTE_AUTO_INCREMENT = new QName(
			DDLUTILS_NAMESPACE, "autoIncrement");
	/** Qualified name of the default attribute. */
	public static final QName QNAME_ATTRIBUTE_DEFAULT = new QName(
			DDLUTILS_NAMESPACE, "default");
	/** Qualified name of the defaultIdMethod attribute. */
	public static final QName QNAME_ATTRIBUTE_DEFAULT_ID_METHOD = new QName(
			DDLUTILS_NAMESPACE, "defaultIdMethod");
	/** Qualified name of the description attribute. */
	public static final QName QNAME_ATTRIBUTE_DESCRIPTION = new QName(
			DDLUTILS_NAMESPACE, "description");
	/** Qualified name of the foreign attribute. */
	public static final QName QNAME_ATTRIBUTE_FOREIGN = new QName(
			DDLUTILS_NAMESPACE, "foreign");
	/** Qualified name of the foreignTable attribute. */
	public static final QName QNAME_ATTRIBUTE_FOREIGN_TABLE = new QName(
			DDLUTILS_NAMESPACE, "foreignTable");
	/** Qualified name of the javaName attribute. */
	public static final QName QNAME_ATTRIBUTE_JAVA_NAME = new QName(
			DDLUTILS_NAMESPACE, "javaName");
	/** Qualified name of the local attribute. */
	public static final QName QNAME_ATTRIBUTE_LOCAL = new QName(
			DDLUTILS_NAMESPACE, "local");
	/** Qualified name of the name attribute. */
	public static final QName QNAME_ATTRIBUTE_NAME = new QName(
			DDLUTILS_NAMESPACE, "name");
	/** Qualified name of the onDelete attribute. */
	public static final QName QNAME_ATTRIBUTE_ON_DELETE = new QName(
			DDLUTILS_NAMESPACE, "onDelete");
	/** Qualified name of the onUpdate attribute. */
	public static final QName QNAME_ATTRIBUTE_ON_UPDATE = new QName(
			DDLUTILS_NAMESPACE, "onUpdate");
	/** Qualified name of the primaryKey attribute. */
	public static final QName QNAME_ATTRIBUTE_PRIMARY_KEY = new QName(
			DDLUTILS_NAMESPACE, "primaryKey");
	/** Qualified name of the required attribute. */
	public static final QName QNAME_ATTRIBUTE_REQUIRED = new QName(
			DDLUTILS_NAMESPACE, "required");
	/** Qualified name of the size attribute. */
	public static final QName QNAME_ATTRIBUTE_SIZE = new QName(
			DDLUTILS_NAMESPACE, "size");
	/** Qualified name of the type attribute. */
	public static final QName QNAME_ATTRIBUTE_TYPE = new QName(
			DDLUTILS_NAMESPACE, "type");
	/** Qualified name of the version attribute. */
	public static final QName QNAME_ATTRIBUTE_VERSION = new QName(
			DDLUTILS_NAMESPACE, "version");
	...
	/**
	 * Reads the database model given by the reader. Note that this method does
	 * not close the given reader.
	 * 
	 * @param reader
	...
	public Database read(Reader reader) throws DdlUtilsXMLException {
		try {
			if (_validateXml) {
				...
				new ModelValidator().validate(new StreamSource(
						new StringReader(tmpXml.toString())));
				return read(getXMLInputFactory().createXMLStreamReader(
						new StringReader(tmpXml.toString())));
			} else {
				return read(getXMLInputFactory().createXMLStreamReader(reader));
			}
	 ...
	 * @return The database model
	 */
	private Database read(XMLStreamReader xmlReader)
	 ...
	 */
	private Database readDatabaseElement(XMLStreamReader xmlReader)
	...
	/**
	 * Reads table elements from the XML stream reader and adds them to the
	 ...
	 */
	private Table readTableElement(XMLStreamReader xmlReader)
			throws XMLStreamException, IOException {
	 ...
	 */
	private Column readColumnElement(XMLStreamReader xmlReader)
			throws XMLStreamException, IOException {
		...
		for (int idx = 0; idx < xmlReader.getAttributeCount(); idx++) {
			...
			if (isSameAs(attrQName, QNAME_ATTRIBUTE_NAME)) {
				...
				column.setAutoIncrement(getAttributeValueAsBoolean(xmlReader,
						idx));
			} else if (isSameAs(attrQName, QNAME_ATTRIBUTE_DESCRIPTION)) {
	 ...
	 */
	private ForeignKey readForeignKeyElement(XMLStreamReader xmlReader)
			throws XMLStreamException, IOException {
		...
		for (int idx = 0; idx < xmlReader.getAttributeCount(); idx++) {
			...
			if (isSameAs(attrQName, QNAME_ATTRIBUTE_FOREIGN_TABLE)) {
				foreignKey
						.setForeignTableName(xmlReader.getAttributeValue(idx));
				...
				foreignKey.setOnUpdate(getAttributeValueAsCascadeEnum(
						xmlReader, idx));
			} else if (isSameAs(attrQName, QNAME_ATTRIBUTE_ON_DELETE)) {
				foreignKey.setOnDelete(getAttributeValueAsCascadeEnum(
						xmlReader, idx));
			}
		}
	 ...
	 *            The foreign key
	 */
	private void readReferenceElements(XMLStreamReader xmlReader,
			ForeignKey foreignKey) throws XMLStreamException, IOException {
		int eventType = XMLStreamReader.START_ELEMENT;
	 ...
	 */
	private Reference readReferenceElement(XMLStreamReader xmlReader)
			throws XMLStreamException, IOException {
		...
		for (int idx = 0; idx < xmlReader.getAttributeCount(); idx++) {
			...
			if (isSameAs(attrQName, QNAME_ATTRIBUTE_LOCAL)) {
				...
				reference
						.setForeignColumnName(xmlReader.getAttributeValue(idx));
			}
		}
		consumeRestOfElement(xmlReader);
		return reference;
	 ...
	 */
	private Index readIndexElement(XMLStreamReader xmlReader)
			throws XMLStreamException, IOException {
	 ...
	 */
	private Index readUniqueElement(XMLStreamReader xmlReader)
			throws XMLStreamException, IOException {
	...
	/**
	 * Reads index column elements from the XML stream reader and adds them to
	 * the given index object.
	 * 
	 * @param xmlReader
	 *            The reader
	 * @param index
	...
	/**
	 * Reads unique index column elements from the XML stream reader and adds
	 * them to the given index object.
	 * 
	 * @param xmlReader
	 *            The reader
	 * @param index
	 ...
	 */
	private IndexColumn readIndexColumnElement(XMLStreamReader xmlReader)
			throws XMLStreamException, IOException {
		...
		for (int idx = 0; idx < xmlReader.getAttributeCount(); idx++) {
			...
			if (isSameAs(attrQName, QNAME_ATTRIBUTE_NAME)) {
				...
				indexColumn.setSize(getAttributeValueBeingNullAware(xmlReader,
						idx));
			}
		}
		consumeRestOfElement(xmlReader);
	...
	/**
	 * Compares the given qnames. This specifically ignores the namespace uri of
	 * the other qname if the namespace of the current element is empty.
	 * 
	 * @param curElemQName
	 ...
	 * string. This method can handle "null" in which case it returns a null
	 * object.
	 * 
	 * @param xmlReader
	 *            The xml reader
	 ...
	 */
	private String getAttributeValueBeingNullAware(XMLStreamReader xmlReader,
			int attributeIdx) throws DdlUtilsXMLException {
	...
	/**
	 * Returns the value of the indicated attribute of the current element as a
	 * boolean. If the value is not a valid boolean, then an exception is
	 * thrown.
	 * 
	 * @param xmlReader
	 *            The xml reader
	 ...
	 */
	private boolean getAttributeValueAsBoolean(XMLStreamReader xmlReader,
			int attributeIdx) throws DdlUtilsXMLException {
		String value = xmlReader.getAttributeValue(attributeIdx);
	 ...
	 * @return The attribute's value as a boolean
	 */
	private CascadeActionEnum getAttributeValueAsCascadeEnum(
			XMLStreamReader xmlReader, int attributeIdx)
			throws DdlUtilsXMLException {
		String value = xmlReader.getAttributeValue(attributeIdx);
		CascadeActionEnum enumValue = value == null ? null : CascadeActionEnum
				.getEnum(value.toLowerCase());
	...
	/**
	 * Consumes the rest of the current element. This assumes that the current
	 * XML stream event type is not START_ELEMENT.
	 * 
	 * @param reader
	 *            The xml reader
	 */
	private void consumeRestOfElement(XMLStreamReader reader)
			throws XMLStreamException {
		int eventType = reader.getEventType();

		while ((eventType != XMLStreamReader.END_ELEMENT)
				&& (eventType != XMLStreamReader.END_DOCUMENT)) {
	 ...
	 *            The xml reader
	 */
	private void readOverElement(XMLStreamReader reader)
			throws XMLStreamException {
		int depth = 1;
	...
	public void write(Database model, OutputStream output)
			throws DdlUtilsXMLException {
		PrettyPrintingXmlWriter xmlWriter = new PrettyPrintingXmlWriter(output,
				"UTF-8");
	 ...
	 *            The output writer
	 */
	public void write(Database model, Writer output)
			throws DdlUtilsXMLException {
		PrettyPrintingXmlWriter xmlWriter = new PrettyPrintingXmlWriter(output,
				"UTF-8");
	 ...
	 *            The XML writer
	 */
	private void writeDatabaseElement(Database model,
		...
		writeAttribute(xmlWriter, QNAME_ATTRIBUTE_DEFAULT_ID_METHOD,
				model.getIdMethod());
	 ...
	 *            The XML writer
	 */
	private void writeTableElement(Table table,
			PrettyPrintingXmlWriter xmlWriter) throws DdlUtilsXMLException {
		...
		writeAttribute(xmlWriter, QNAME_ATTRIBUTE_DESCRIPTION,
				table.getDescription());
		if ((table.getColumnCount() > 0) || (table.getForeignKeyCount() > 0)
				|| (table.getIndexCount() > 0)) {
			xmlWriter.printlnIfPrettyPrinting();
	 ...
	 *            The XML writer
	 */
	private void writeColumnElement(Column column,
			PrettyPrintingXmlWriter xmlWriter) throws DdlUtilsXMLException {
		...
		writeAttribute(xmlWriter, QNAME_ATTRIBUTE_PRIMARY_KEY,
				String.valueOf(column.isPrimaryKey()));
		writeAttribute(xmlWriter, QNAME_ATTRIBUTE_REQUIRED,
		...
		writeAttribute(xmlWriter, QNAME_ATTRIBUTE_DEFAULT,
				column.getDefaultValue());
		writeAttribute(xmlWriter, QNAME_ATTRIBUTE_AUTO_INCREMENT,
				String.valueOf(column.isAutoIncrement()));
		writeAttribute(xmlWriter, QNAME_ATTRIBUTE_DESCRIPTION,
				column.getDescription());
		writeAttribute(xmlWriter, QNAME_ATTRIBUTE_JAVA_NAME,
				column.getJavaName());
		writeElementEnd(xmlWriter);
	}
	 ...
	 *            The XML writer
	 */
	private void writeForeignKeyElement(ForeignKey foreignKey,
			PrettyPrintingXmlWriter xmlWriter) throws DdlUtilsXMLException {
		xmlWriter.indentIfPrettyPrinting(2);
		...
		if (foreignKey.getOnUpdate() != CascadeActionEnum.NONE) {
			writeAttribute(xmlWriter, QNAME_ATTRIBUTE_ON_UPDATE, foreignKey
					.getOnUpdate().getName());
		}
		if (foreignKey.getOnDelete() != CascadeActionEnum.NONE) {
			writeAttribute(xmlWriter, QNAME_ATTRIBUTE_ON_DELETE, foreignKey
					.getOnDelete().getName());
		}
	 ...
	 *            The XML writer
	 */
	private void writeReferenceElement(Reference reference,
			PrettyPrintingXmlWriter xmlWriter) throws DdlUtilsXMLException {
		xmlWriter.indentIfPrettyPrinting(3);
		writeElementStart(xmlWriter, QNAME_ELEMENT_REFERENCE);
		writeAttribute(xmlWriter, QNAME_ATTRIBUTE_LOCAL,
				reference.getLocalColumnName());
		writeAttribute(xmlWriter, QNAME_ATTRIBUTE_FOREIGN,
	 ...
	 *            The XML writer
	 */
	private void writeIndexElement(Index index,
			PrettyPrintingXmlWriter xmlWriter) throws DdlUtilsXMLException {
		xmlWriter.indentIfPrettyPrinting(2);
		writeElementStart(xmlWriter, index.isUnique()
		...
		if (index.getColumnCount() > 0) {
			...
			for (int idx = 0; idx < index.getColumnCount(); idx++) {
				writeIndexColumnElement(index.getColumn(idx), index.isUnique(),
						xmlWriter);
			}
			xmlWriter.indentIfPrettyPrinting(2);
		}
	 ...
	 *            The XML writer
	 */
	private void writeIndexColumnElement(IndexColumn indexColumn,
			boolean isUnique, PrettyPrintingXmlWriter xmlWriter)
			throws DdlUtilsXMLException {
		xmlWriter.indentIfPrettyPrinting(3);
		writeElementStart(xmlWriter, isUnique
	 ...
	 */
	private void writeElementStart(PrettyPrintingXmlWriter xmlWriter,
			QName qName) throws DdlUtilsXMLException {
		xmlWriter.writeElementStart(qName.getNamespaceURI(),
				qName.getLocalPart());
	}
	 ...
	 */
	private void writeAttribute(PrettyPrintingXmlWriter xmlWriter, QName qName,
			String value) throws DdlUtilsXMLException {
		if (value != null) {
	 ...
	 *            The xml writer
	 */
	private void writeElementEnd(PrettyPrintingXmlWriter xmlWriter)
			throws DdlUtilsXMLException {
