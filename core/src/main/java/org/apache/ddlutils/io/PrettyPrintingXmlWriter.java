...
public class PrettyPrintingXmlWriter {
	 ...
	 */
	public PrettyPrintingXmlWriter(OutputStream output)
	 ...
	 */
	public PrettyPrintingXmlWriter(OutputStream output, String encoding)
			throws DdlUtilsXMLException {
	...
	/**
	 * Creates a xml writer instance using the specified writer. Note that the
	 ...
	 */
	public PrettyPrintingXmlWriter(Writer output, String encoding)
			throws DdlUtilsXMLException {
	...
	/**
	 * Rethrows the given exception, wrapped in a {@link DdlUtilsXMLException}.
	 * This method allows subclasses to throw their own subclasses of this
	 * exception.
	 * 
	 * @param baseEx
	 ...
	 * 
	 * @param prefix
	 *            The prefix for the namespace, use <code>null</code> or an
	 ...
	 *            The namespace uri, can be <code>null</code>
	 * @param localPart
	 *            The local part of the element's qname
	 */
	public void writeElementStart(String namespaceUri, String localPart)
			throws DdlUtilsXMLException {
		try {
	 ...
	 *            The namespace uri, can be <code>null</code>
	 * @param localPart
	 *            The local part of the attribute's qname
	 * @param value
	 *            The value; if <code>null</code> then no attribute is written
	 */
	public void writeAttribute(String namespaceUri, String localPart,
