...
public interface Platform {
	...
	/**
	 * Determines whether the default action for ON UPDATE is used if the
	 * specified one is not supported by the platform. If this is set to
	 * <code>false</code>, then an exception will be thrown if the action is not
	 * supported. By default, this is set to <code>true</code> meaning that the
	 * default action would be used.
	 * 
	...
	/**
	 * Specifies whether the default action for ON UPDATE shall be used if the
	 * specified one is not supported by the platform. If this is set to
	 * <code>false</code>, then an exception will be thrown if the action is not
	 * supported. By default, this is set to <code>true</code> meaning that the
	 * default action would be used.
	 * 
	 * @param useDefault
	 *            If <code>true</code> then the default action will be used
	 */
	public void setDefaultOnUpdateActionUsedIfUnsupported(boolean useDefault);

	/**
	 * Determines whether the default action for ON DELETE is used if the
	 * specified one is not supported by the platform. If this is set to
	 * <code>false</code>, then an exception will be thrown if the action is not
	 * supported. By default, this is set to <code>true</code> meaning that the
	 * default action would be used.
	...
	/**
	 * Specifies whether the default action for ON DELETE shall be used if the
	 * specified one is not supported by the platform. If this is set to
	 * <code>false</code>, then an exception will be thrown if the action is not
	 * supported. By default, this is set to <code>true</code> meaning that the
	 * default action would be used.
	 ...
	 *            occurred
	 * @deprecated Use
	 *             {@link #createModel(Connection, Database, boolean, boolean)}
	 *             instead.
	 */
	 ...
	 * @deprecated Use {@link #getCreateModelSql(Database, boolean, boolean)}
	 *             instead.
	 */
	 ...
	 * @return The SQL statements
	 * @deprecated Use
	 *             {@link #getCreateModelSql(Database, CreationParameters, boolean, boolean)}
	 *             instead.
	 */
	...
	/**
	 * Returns the necessary changes to apply to the current database to make it
	 * the desired one. These changes are in the correct order and have been
	 * adjusted for the current platform.
	 * 
	 * @param currentModel
	 *            The current model
	 * @param desiredModel
	 *            The desired model
	 * @return The list of changes, adjusted to the platform and sorted for
	 *         execution
	 */
	 ...
	 *            occurred
	 * @deprecated Use
	 *             {@link #alterModel(Connection, Database, Database, boolean)}
	 *             together with
	 ...
	 *            The desired database schema
	 * @return The SQL statements
	 * @deprecated Use {@link #getAlterModelSql(Database, Database)} together
	 *             with {@link #readModelFromDatabase(String)} instead.
	 */
	 ...
	 * @return The SQL statements
	 * @deprecated Use {@link #getAlterModelSql(Database, Database)} together
	 *             with {@link #readModelFromDatabase(Connection, String)}
	 *             instead.
	 */
	 ...
	 *            Whether to continue executing the sql commands when an error
	 *            occurred
	 * @deprecated Use {@link #dropModel(Connection, Database, boolean)}
	 *             instead.
	 */
	...
	/**
	 * Determines whether the given dyna bean is stored in the database. Note
	 * that this checks only checks the primary key, not the other attributes.
	 * 
	 * @param model
	 *            The database model to use
	 * @param dynaBean
	 *            The bean
	 * @return <code>true</code> if a bean with this primary key exists in the
	 *         database
	 */
	...
	/**
	 * Returns the sql for updating the given bean in the database. Note that
	 * this method can not be used to generate SQL for updating primary key
	 * columns.
	 * 
	 * @param model
	 *            The database model to use
	 ...
	 *            The database model to use
	 * @param oldDynaBean
	 *            The bean identifying the row to update
	 * @param newDynaBean
	 *            The bean containing the new values
	 * @return The update sql
	 */
	 ...
	 * are specified. Note that this means that this method will not update the
	 * primary key columns.
	 * 
	 * @param model
	 *            The database model to use
	...
	/**
	 * Updates the row which maps to the given bean. Note that this means that
	 * this method will not update the primary key columns.
	 * 
	 * @param connection
	 *            The database connection
	 * @param model
	 ...
	 * database with the values in <code>newDynaBean</code>. This method can be
	 * used to update primary key columns.
	 * 
	 * @param model
	 *            The database model to use
	 * @param oldDynaBean
	 *            The bean identifying the row (which means the primary key
