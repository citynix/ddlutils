...
public abstract class DatabaseTaskBase extends Task {
	...
	public void execute() throws BuildException {
		...
		ClassLoader sysClassLoader = (ClassLoader) AccessController
				.doPrivileged(new PrivilegedAction() {
					public Object run() {
						try {
							ClassLoader contextClassLoader = Thread
									.currentThread().getContextClassLoader();
							AntClassLoader newClassLoader = new AntClassLoader(
									getClass().getClassLoader(), true);

							// we're changing the thread classloader so that we
							...
							throw new BuildException(
									"Could not change the context clas loader",
									ex);
						}
					}
				});
