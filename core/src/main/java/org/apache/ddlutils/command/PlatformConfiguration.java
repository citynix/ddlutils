...
/**
 * Encloses the platform configuration for the command. One can think of this as a command configuration. 
 * For example, parameters and switches, should go here.
 * 
...
public class PlatformConfiguration
{
    ...
    public Platform getPlatform() throws CommandException
    {
        if (_platform == null)
        {
            ...
            {
                throw new CommandException("Database type "+_databaseType+" is not supported.", ex);
            }
            if (_platform == null)
            {
                throw new CommandException("Database type "+_databaseType+" is not supported.");
            }
