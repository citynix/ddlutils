...
public class SqlDynaClass extends BasicDynaClass {
	...
	public SqlDynaProperty[] getPrimaryKeyProperties() {
		...
		System.arraycopy(_primaryKeyProperties, 0, result, 0,
				_primaryKeyProperties.length);
		return result;
	}
	...
	public SqlDynaProperty[] getNonPrimaryKeyProperties() {
		...
		System.arraycopy(_nonPrimaryKeyProperties, 0, result, 0,
				_nonPrimaryKeyProperties.length);
		return result;
	}
