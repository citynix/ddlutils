...
public class PlatformInfo {
	...
	/**
	 * Whether mixed identity and non-identity columns in a primary key is
	 * supported.
	 */
	...
	/**
	 * Determines whether the primary key constraints have to be required, as
	 * well.
	 * 
	...
	/**
	 * Specifies whether the primary key constraints have to be required, as
	 * well.
	 * 
	 * @param primaryKeyColumnsHaveToBeRequired
	 *            Whether pk constraints need to be required
	 */
	public void setPrimaryKeyColumnsHaveToBeRequired(
			boolean primaryKeyColumnsHaveToBeRequired) {
		_primaryKeyColumnsHaveToBeRequired = primaryKeyColumnsHaveToBeRequired;
	}

	/**
	 * Determines whether primary key can contain identity and non-identity
	 * columns at the same time.
	 * 
	 * @return <code>true</code> if idenity and non-identity columns can be
	 *         mixed in the pk
	 */
	...
	/**
	 * Specifies whether primary key can contain identity and non-identity
	 * columns at the same time.
	 * 
	 * @param mixingIdentityAndNormalPrimaryKeyColumnsSupported
	 *            Whether idenity and non-identity columns can be mixed in the
	 *            pk
	 */
	public void setMixingIdentityAndNormalPrimaryKeyColumnsSupported(
			boolean mixingIdentityAndNormalPrimaryKeyColumnsSupported) {
	 ...
	 *            auto-incrementing
	 */
	public void setNonPrimaryKeyIdentityColumnsSupported(
			boolean supportingNonPKIdentityColumns) {
		_nonPrimaryKeyIdentityColumnsSupported = supportingNonPKIdentityColumns;
	}

	/**
	 * Determines whether multiple columns in the same table can be
	 * auto-incrementing (IDENTITY columns).
	 * 
	 * @return <code>true</code> if multiple columns can be auto-incrementing in
	 *         the same table
	 */
	...
	/**
	 * Specifies whether multiple columns in the same table can be
	 * auto-incrementing (IDENTITY columns).
	 * 
	 * @param supportingMultipleIdentityColumns
	 *            <code>true</code> if multiple columns can be auto-incrementing
	 *            in the same table
	 */
	public void setMultipleIdentityColumnsSupported(
			boolean supportingMultipleIdentityColumns) {
	 ...
	 *            DEFAULT value
	 */
	public void setDefaultValueUsedForIdentitySpec(
			boolean identitySpecUsesDefaultValue) {
	...
	/**
	 * Determines whether the database will make a primary key column
	 * automatically required.
	 * 
	 * @return <code>true</code> if primary key columns are automatically
	 *         required
	 */
	...
	/**
	 * Specifies whether the database will make a primary key column
	 * automatically required.
	 * 
	 * @param primaryKeyAutomaticallyRequired
	 *            <code>true</code> if primary key columns are automatically
	 *            required
	 */
	public void setPrimaryKeyColumnAutomaticallyRequired(
			boolean primaryKeyAutomaticallyRequired) {
		_primaryKeyColumnAutomaticallyRequired = primaryKeyAutomaticallyRequired;
	}

	/**
	 * Determines whether the database will make an idenity column automatically
	 * required.
	 * 
	 ...
	 * automatically required.
	 * 
	 * @param identityAutomaticallyRequired
	 *            <code>true</code> if identity columns are automatically
	 *            required
	 */
	public void setIdentityColumnAutomaticallyRequired(
			boolean identityAutomaticallyRequired) {
	...
	/**
	 * Determines whether the given action is supported for ON UPDATE on this
	 * platform.
	 * 
	 * @param action
	 *            The action
	...
	/**
	 * Determines whether the given action is supported for ON DELETE on this
	 * platform.
	 * 
	 * @param action
	 *            The action
	 ...
	 * Equivalent actions will not cause a foreign key to be changed/recreated
	 * when altering a database.
	 * 
	 * @param actionA
	 *            The first action
	 * @param actionB
	...
	public void addEquivalentOnUpdateActions(CascadeActionEnum actionA,
		...
		if (!actionA.equals(actionB)) {
			Set actionsEquivalentToActionA = (Set) _equivalentOnUpdateActions
					.get(actionA);
			Set actionsEquivalentToActionB = (Set) _equivalentOnUpdateActions
					.get(actionB);
	...
	/**
	 * Determiones whether the two ON UPDATE actions are equivalent. Equivalent
	 * actions will not cause a foreign key to be changed/recreated when
	 * altering a database.
	 * 
	 * @param actionA
	 *            The first action
	...
	public boolean areEquivalentOnUpdateActions(CascadeActionEnum actionA,
		...
		return actionsEquivalentToActionA == null
				? false
	...
	public void addEquivalentOnDeleteActions(CascadeActionEnum actionA,
		...
		if (!actionA.equals(actionB)) {
			Set actionsEquivalentToActionA = (Set) _equivalentOnDeleteActions
					.get(actionA);
			Set actionsEquivalentToActionB = (Set) _equivalentOnDeleteActions
					.get(actionB);
	...
	/**
	 * Determiones whether the two ON DELETE actions are equivalent. Equivalent
	 * actions will not cause a foreign key to be changed/recreated when
	 * altering a database.
	 * 
	 * @param actionA
