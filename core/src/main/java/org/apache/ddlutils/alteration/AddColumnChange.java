...
public class AddColumnChange extends TableChangeImplBase {
	 ...
	 *            The name of the column after which the new column should be
	 *            added
	 * @param nextColumnName
	 *            The name of the column before which the new column should be
	 *            added
	 */
	public AddColumnChange(String tableName, Column newColumn,
			String previousColumnName, String nextColumnName) {
		super(tableName);
	...
	/**
	 * Returns the name of the column after which the new column should be
	 * added.
	 * 
	...
	/**
	 * Returns the name of the column before which the new column should be
	 * added.
	 * 
	...
	public void apply(Database model, boolean caseSensitive) {
		...
		if (_previousColumnName != null) {
			Column prevColumn = table.findColumn(_previousColumnName,
					caseSensitive);
