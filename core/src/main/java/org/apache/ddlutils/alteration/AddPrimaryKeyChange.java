...
public class AddPrimaryKeyChange extends TableChangeImplBase {
	 ...
	 * 
	 * @param tableName
	 *            The name of the table to add the primary key to
	...
	public AddPrimaryKeyChange(String tableName, String[] primaryKeyColumns) {
		...
		if (primaryKeyColumns == null) {
			...
			System.arraycopy(primaryKeyColumns, 0, _primaryKeyColumns, 0,
	...
	public String[] getPrimaryKeyColumns() {
		...
		System.arraycopy(_primaryKeyColumns, 0, result, 0,
				_primaryKeyColumns.length);
		return result;
	}
	...
	public void apply(Database model, boolean caseSensitive) {
		...
		for (int idx = 0; idx < _primaryKeyColumns.length; idx++) {
			Column column = table.findColumn(_primaryKeyColumns[idx],
					caseSensitive);
