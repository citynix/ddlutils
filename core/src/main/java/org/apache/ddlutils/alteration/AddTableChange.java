...
public class AddTableChange implements ModelChange {
	 ...
	 * 
	 * @param newTable
	 *            The new table; note that the change object will keep a
	 *            reference to this table which means that the table should not
	...
	public void apply(Database database, boolean caseSensitive) {
		Table table = new CloneHelper().clone(_newTable, true, false, database,
				caseSensitive);
