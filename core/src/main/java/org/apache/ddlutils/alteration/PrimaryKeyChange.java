...
public class PrimaryKeyChange extends TableChangeImplBase {
	 ...
	 * 
	 * @param tableName
	 *            The name of the table whose primary key is to be changed
	...
	public PrimaryKeyChange(String tableName, String[] newPrimaryKeyColumns) {
		...
		if (newPrimaryKeyColumns == null) {
			...
			System.arraycopy(newPrimaryKeyColumns, 0, _newPrimaryKeyColumns, 0,
					newPrimaryKeyColumns.length);
		}
	}
	...
	public String[] getNewPrimaryKeyColumns() {
		...
		System.arraycopy(_newPrimaryKeyColumns, 0, result, 0,
				_newPrimaryKeyColumns.length);
		return result;
	}
