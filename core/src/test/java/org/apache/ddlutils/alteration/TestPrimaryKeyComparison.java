...
public class TestPrimaryKeyComparison extends TestComparisonBase {
	...
	public void testMakeColumnPrimaryKey() {
		...
		assertEquals(1, change.getPrimaryKeyColumns().length);
		assertEquals("ColPK", change.getPrimaryKeyColumns()[0]);
	}
	...
	public void testAddColumnToPrimaryKey() {
		...
		assertEquals("TableA", change.getChangedTable());
		assertEquals(2, change.getNewPrimaryKeyColumns().length);
		assertEquals("ColPK1", change.getNewPrimaryKeyColumns()[0]);
		assertEquals("ColPK2", change.getNewPrimaryKeyColumns()[1]);
	}
	...
	public void testChangeColumnOrderInPrimaryKey() {
		...
		assertEquals("ColPK2", pkChange.getNewPrimaryKeyColumns()[0]);
		assertEquals("ColPK3", pkChange.getNewPrimaryKeyColumns()[1]);
		assertEquals("ColPK1", pkChange.getNewPrimaryKeyColumns()[2]);

		assertEquals("TableA", colChange.getChangedTable());
		assertEquals(2, colChange.getNewPosition("ColPK1", true));
		assertEquals(0, colChange.getNewPosition("ColPK2", true));
		assertEquals(1, colChange.getNewPosition("ColPK3", true));
	}

	/**
	 * Tests adding a column to and changing the order of columns in the primary
	 * key.
	 */
	public void testAddColumnAndChangeColumnOrderInPrimaryKey() {
		...
		assertEquals("TableA", pkChange1.getChangedTable());
		assertEquals(2, pkChange1.getNewPrimaryKeyColumns().length);
		assertEquals("ColPK3", pkChange1.getNewPrimaryKeyColumns()[0]);
		assertEquals("ColPK1", pkChange1.getNewPrimaryKeyColumns()[1]);

		assertEquals("TableA", colChange1.getChangedTable());
		assertEquals(1, colChange1.getNewPosition("ColPK1", true));
		assertEquals(-1, colChange1.getNewPosition("ColPK2", true));
		assertEquals(0, colChange1.getNewPosition("ColPK3", true));
		...
		assertEquals("TableA", pkChange2.getChangedTable());
		assertEquals(3, pkChange2.getNewPrimaryKeyColumns().length);
		assertEquals("ColPK2", pkChange2.getNewPrimaryKeyColumns()[0]);
		assertEquals("ColPK3", pkChange2.getNewPrimaryKeyColumns()[1]);
		assertEquals("ColPK1", pkChange2.getNewPrimaryKeyColumns()[2]);
	}

	/**
	 * Tests removing a column from and changing the order of columns in the
	 * primary key.
	 */
	public void testRemoveColumnAndChangeColumnOrderInPrimaryKey() {
		...
		assertEquals("TableA", colChange1.getChangedTable());
		assertEquals("ColPK2", colChange1.getChangedColumn());

		assertEquals("TableA", pkChange.getChangedTable());
		assertEquals(2, pkChange.getNewPrimaryKeyColumns().length);
		assertEquals("ColPK3", pkChange.getNewPrimaryKeyColumns()[0]);
		assertEquals("ColPK1", pkChange.getNewPrimaryKeyColumns()[1]);

		assertEquals("TableA", colChange2.getChangedTable());
		assertEquals(1, colChange2.getNewPosition("ColPK1", true));
		assertEquals(-1, colChange2.getNewPosition("ColPK2", true));
		assertEquals(0, colChange2.getNewPosition("ColPK3", true));
	}
	...
	public void testMakeColumnNotPrimaryKey() {
		...
		assertEquals("TableA", change.getChangedTable());
		assertEquals(1, change.getNewPrimaryKeyColumns().length);
		assertEquals("ColPK2", change.getNewPrimaryKeyColumns()[0]);
	}
	...
	public void testDropPrimaryKeyColumn1() {
		...
		assertEquals("TableA", colChange.getChangedTable());
		assertEquals("ColPK", colChange.getChangedColumn());
	}
	...
	public void testDropPrimaryKeyColumn2() {
		...
		assertEquals("TableA", colChange.getChangedTable());
		assertEquals("ColPK2", colChange.getChangedColumn());
	}
	...
	public void testRemovePrimaryKey2() {
		...
		RemovePrimaryKeyChange pkChange = (RemovePrimaryKeyChange) changes
				.get(0);
	...
	public void testChangePrimaryKeyColumns() {
		...
		assertEquals(2, pkChange.getNewPrimaryKeyColumns().length);
		assertEquals("ColPK2", pkChange.getNewPrimaryKeyColumns()[0]);
		assertEquals("ColPK4", pkChange.getNewPrimaryKeyColumns()[1]);
	}
}
