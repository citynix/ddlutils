...
public class TestAlterationAlgorithm extends TestBase {
	 ...
	 * @return The sql
	 */
	protected String getAlterModelSQL(String currentSchema, String desiredSchema)
			throws IOException {
	...
	/**
	 * Tests the addition of columns to the primary key of a table and the
	 * foreign key of another table referencing it.
	 */
	...
	/**
	 * Tests the removal of columns from the primary key of a table and the
	 * foreign key of another table referencing it.
	 */
	 ...
	 * key.
	 */
	public void testInsertColumnToTableReferencedByForeignKey()
			throws IOException {
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	 ...
	 * foreign key.
	 */
	public void testAddExistingColumnsToPrimaryAndForeignKey()
			throws IOException {
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	 ...
	 * foreign key.
	 */
	public void testRemoveExistingColumnsFromPrimaryAndForeignKey()
			throws IOException {
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	 ...
	 */
	public void testRemoveColumnFromTableReferencedByForeignKey()
			throws IOException {
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	 ...
	 */
	public void testChangePrimaryAndForeignKeyColumnsDatatype()
			throws IOException {
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	...
	/**
	 * Tests the change of the default value of the columns of a primary key and
	 * the referencing foreign key.
	 */
	public void testChangePrimaryAndForeignKeyColumnsDefault()
			throws IOException {
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	 ...
	 * primary key and the referencing foreign key.
	 */
	public void testChangePrimaryAndForeignKeyColumnsAutoIncrement()
			throws IOException {
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	 ...
	 */
	public void testChangePrimaryAndForeignKeyColumnsRequired()
			throws IOException {
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
