...
public class TestForeignKeyComparison extends TestComparisonBase {
	...
	public void testAddColumnAndForeignKey() {
		final String MODEL1 = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				...
				+ "    <column name='ColPK' type='INTEGER' primaryKey='true' required='true'/>\n"
				+ "  </table>\n" + "</database>";
		final String MODEL2 = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
				+ "' name='test'>\n"
				+ "  <table name='TABLEA'>\n"
		...
		assertEquals("TableA", colChange.getChangedTable());
		assertColumn("COLFK", Types.INTEGER, null, null, false, false, false,
				colChange.getNewColumn());
		assertEquals("ColPK", colChange.getPreviousColumn());
		assertNull(colChange.getNextColumn());

		assertEquals("TableA", fkChange.getChangedTable());
		assertForeignKey("TESTFK", "TableB", new String[]{"COLFK"},
				new String[]{"ColPK"}, fkChange.getNewForeignKey());
	}
	...
	public void testAddColumnAndForeignKeyToIt() {
		...
		assertEquals("TableB", colChange.getChangedTable());
		assertColumn("COLPK", Types.INTEGER, null, null, false, true, false,
				colChange.getNewColumn());
		assertNull(colChange.getPreviousColumn());
		assertEquals("Col", colChange.getNextColumn());

		assertEquals("TableB", pkChange.getChangedTable());
		assertEquals(1, pkChange.getPrimaryKeyColumns().length);
		assertEquals("COLPK", pkChange.getPrimaryKeyColumns()[0]);
	...
	public void testAddColumnsAndForeignKey() {
		...
		assertEquals("TableA", colChange1.getChangedTable());
		assertColumn("COLFK1", Types.INTEGER, null, null, false, false, false,
				colChange1.getNewColumn());
		assertEquals("ColPK", colChange1.getPreviousColumn());
		assertNull(colChange1.getNextColumn());

		assertEquals("TableA", colChange2.getChangedTable());
		assertColumn("COLFK2", Types.DOUBLE, null, null, false, false, false,
				colChange2.getNewColumn());
		assertEquals("COLFK1", colChange2.getPreviousColumn());
		assertNull(colChange2.getNextColumn());

		assertEquals("TableA", colChange3.getChangedTable());
		assertColumn("COLFK3", Types.VARCHAR, "32", null, false, false, false,
				colChange3.getNewColumn());
		assertEquals("COLFK2", colChange3.getPreviousColumn());
		assertNull(colChange3.getNextColumn());

		assertEquals("TableA", fkChange.getChangedTable());
		assertForeignKey("TESTFK", "TableB", new String[]{"COLFK2", "COLFK1",
				"COLFK3"}, new String[]{"ColPK1", "ColPK2", "ColPK3"},
	...
	public void testAddColumnsAndForeignKeyToThem() {
		...
		assertEquals("TableB", colChange1.getChangedTable());
		assertColumn("COLPK1", Types.DOUBLE, null, null, false, true, false,
				colChange1.getNewColumn());
		assertNull(colChange1.getPreviousColumn());
		assertEquals("ColPK3", colChange1.getNextColumn());

		assertEquals("TableB", colChange2.getChangedTable());
		assertColumn("COLPK2", Types.INTEGER, null, null, false, true, false,
				colChange2.getNewColumn());
		assertEquals("COLPK1", colChange2.getPreviousColumn());
		assertEquals("ColPK3", colChange2.getNextColumn());

		assertEquals("TableB", pkChange.getChangedTable());
		assertEquals(3, pkChange.getNewPrimaryKeyColumns().length);
		assertEquals("COLPK1", pkChange.getNewPrimaryKeyColumns()[0]);
		assertEquals("COLPK2", pkChange.getNewPrimaryKeyColumns()[1]);
		assertEquals("ColPK3", pkChange.getNewPrimaryKeyColumns()[2]);
	...
	public void testAddColumnsAndForeignKeyBetweenThem() {
		...
		assertColumn("COLFK1", Types.INTEGER, null, null, false, false, false,
				colChange1.getNewColumn());
		assertEquals("ColPK", colChange1.getPreviousColumn());
		assertEquals("ColFK2", colChange1.getNextColumn());

		assertEquals("TableA", colChange2.getChangedTable());
		assertColumn("COLFK3", Types.VARCHAR, "32", null, false, false, false,
				colChange2.getNewColumn());
		assertEquals("ColFK2", colChange2.getPreviousColumn());
		assertNull(colChange2.getNextColumn());

		assertEquals("TableB", colChange3.getChangedTable());
		assertColumn("COLPK1", Types.DOUBLE, null, null, false, true, false,
				colChange3.getNewColumn());
		assertNull(colChange3.getPreviousColumn());
		assertEquals("ColPK3", colChange3.getNextColumn());

		assertEquals("TableB", colChange4.getChangedTable());
		assertColumn("COLPK2", Types.INTEGER, null, null, false, true, false,
				colChange4.getNewColumn());
		assertEquals("COLPK1", colChange4.getPreviousColumn());
		assertEquals("ColPK3", colChange4.getNextColumn());
	...
	public void testAddSingleReferenceForeignKey() {
		...
		assertEquals("TableA", change.getChangedTable());
		assertForeignKey("TESTFK", "TableB", new String[]{"ColFK"},
				new String[]{"ColPK"}, change.getNewForeignKey());
	}
	...
	public void testAddLocalColumnToMultiReferenceForeignKey() {
		...
		assertColumn("COLFK2", Types.DOUBLE, null, null, false, false, false,
				colChange.getNewColumn());
		assertEquals("ColFK1", colChange.getPreviousColumn());
		assertEquals("ColFK3", colChange.getNextColumn());
		...
		assertEquals("TableA", fkChange2.getChangedTable());
		assertForeignKey("TESTFK", "TableB", new String[]{"COLFK2", "ColFK1",
				"ColFK3"}, new String[]{"ColPK1", "ColPK2", "COLPK3"},
	...
	public void testAddForeignColumnToMultiReferenceForeignKey() {
		...
		assertColumn("COLPK3", Types.VARCHAR, "32", null, false, true, false,
				colChange.getNewColumn());
		assertEquals("ColPK2", colChange.getPreviousColumn());
		assertNull(colChange.getNextColumn());
	...
	public void testAddColumnsToSingleReferenceForeignKey() {
		...
		assertColumn("COLPK2", Types.INTEGER, null, null, false, true, false,
				colChange3.getNewColumn());
		assertEquals("ColPK1", colChange3.getPreviousColumn());
		assertNull(colChange3.getNextColumn());

		assertEquals("TableB", colChange4.getChangedTable());
		assertColumn("COLPK3", Types.VARCHAR, "32", null, false, true, false,
				colChange4.getNewColumn());
		assertEquals("COLPK2", colChange4.getPreviousColumn());
	...
	/**
	 * Tests adding a reference to a foreign key and changing the order of
	 * references.
	 */
	public void testAddReferenceToForeignKeyAndChangeOrder() {
		...
		assertEquals("TableA", fkChange2.getChangedTable());
		assertForeignKey("TESTFK", "TableB", new String[]{"ColFK1", "ColFK2",
				"ColFK3"}, new String[]{"COLPK2", "COLPK1", "COLPK3"},
				fkChange2.getNewForeignKey());
	}
	...
	public void testRemoveReferenceFromForeignKey() {
		...
		assertEquals("TableB", pkChange.getChangedTable());
		assertEquals(2, pkChange.getNewPrimaryKeyColumns().length);
		assertEquals("COLPK1", pkChange.getNewPrimaryKeyColumns()[0]);
		assertEquals("COLPK2", pkChange.getNewPrimaryKeyColumns()[1]);

		assertEquals("TableA", fkChange2.getChangedTable());
		assertForeignKey("TESTFK", "TableB", new String[]{"ColFK1", "ColFK2"},
				new String[]{"COLPK2", "COLPK1"}, fkChange2.getNewForeignKey());
	}

	/**
	 * Tests removing a reference from a foreign key and changing the order of
	 * references.
	 */
	public void testRemoveReferenceFromForeignKeyAndChangeOrder() {
		...
		assertEquals("TableA", fkChange2.getChangedTable());
		assertForeignKey("TESTFK", "TableB", new String[]{"ColFK2", "ColFK1"},
				new String[]{"COLPK1", "COLPK2"}, fkChange2.getNewForeignKey());
	}
	...
	public void testDropColumnsFromForeignKey() {
		...
		assertEquals("TableA", colChange1.getChangedTable());
		assertEquals("ColFK3", colChange1.getChangedColumn());

		assertEquals("TableB", colChange2.getChangedTable());
		assertEquals("COLPK1", colChange2.getChangedColumn());

		assertEquals("TableB", colChange3.getChangedTable());
		assertEquals("COLPK3", colChange3.getChangedColumn());

		assertEquals("TableA", fkChange2.getChangedTable());
		assertForeignKey("TESTFK", "TableB", new String[]{"ColFK1"},
				new String[]{"COLPK2"}, fkChange2.getNewForeignKey());
	}
	...
	public void testDropSingleReferenceForeignKey() {
		...
		assertEquals("TableB", change.getChangedTable());
	...
	public void testDropMultiReferenceForeignKey() {
		...
		RemoveForeignKeyChange fkChange = (RemoveForeignKeyChange) changes
				.get(0);
	...
	public void testAddAndDropForeignKey1() {
		...
		RemoveForeignKeyChange change1 = (RemoveForeignKeyChange) changes
				.get(0);
		AddForeignKeyChange change2 = (AddForeignKeyChange) changes.get(1);

		assertEquals("TableB", change1.getChangedTable());
		assertEquals(model1.findTable("TableB").getForeignKey(0),
				change1.findChangedForeignKey(model1, true));

		assertEquals("TableB", change2.getChangedTable());
		assertForeignKey("TESTFK", "TableA", new String[]{"ColFK"},
				new String[]{"ColPK"}, change2.getNewForeignKey());
	}

	/**
	 * Tests the recreation of a foreign key because of a change of the
	 * references.
	 */
	public void testAddAndDropForeignKey2() {
		...
		assertEquals("TableA", change1.getChangedTable());
		assertEquals(model1.findTable("TableA").getForeignKey(0),
				change1.findChangedForeignKey(model1, true));

		assertEquals("TableA", change2.getChangedTable());
		assertForeignKey("TestFK", "TableB", new String[]{"ColFK1", "ColFK2"},
				new String[]{"ColPK2", "ColPK1"}, change2.getNewForeignKey());
	}
