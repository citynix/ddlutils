...
public class TestModelComparison extends TestComparisonBase {
	...
	public void testAddTableWithIndex() {
		...
		assertIndex("TestIndex", false, new String[]{"COLA"}, change
				.getNewTable().getIndex(0));
	}
	...
	public void testAddTableAndForeignKeyToIt() {
		...
		assertForeignKey("TESTFKB", "TABLEB", new String[]{"COLFK"},
	...
	public void testAddTablesWithForeignKeys() {
		...
		assertForeignKey("TESTFKB", "TABLEB", new String[]{"COLFK"},
				new String[]{"COLPK"}, fkChange1.getNewForeignKey());

		assertEquals("TABLEB", fkChange2.getChangedTable());
		assertForeignKey("TESTFKA", "TABLEA", new String[]{"COLFK"},
				new String[]{"COLPK"}, fkChange2.getNewForeignKey());
	}
	...
	public void testDropTableWithForeignKey() {
		...
		assertEquals("TableA", tableChange.getChangedTable());
	}
	...
	public void testDropTableAndForeignKeyToIt() {
		...
		assertEquals("TableB", fkChange.getChangedTable());
