...
public class TestIndexComparison extends TestComparisonBase {
	...
	public void testAddSingleColumnIndex2() {
		...
		assertEquals("TableA", indexChange.getChangedTable());
		assertIndex("TESTINDEX", false, new String[]{"COL"},
	...
	public void testAddMultiColumnIndex2() {
		...
		assertEquals("COL1", colChange2.getPreviousColumn());
		...
		assertEquals("COL2", colChange3.getPreviousColumn());
	...
	/**
	 * Tests the addition of a column into an existing index with multiple
	 * columns.
	 */
	public void testAddNewColumnToMultiColumnIndex() {
		...
		assertEquals("TableA", indexChange1.getChangedTable());
		...
		assertColumn("COL2", Types.DOUBLE, null, null, false, false, false,
				colChange.getNewColumn());
		assertEquals("COL1", colChange.getPreviousColumn());
		assertEquals("COL3", colChange.getNextColumn());

		assertEquals("TableA", indexChange2.getChangedTable());
		assertIndex("TESTINDEX", true, new String[]{"COL3", "COL1", "COL2"},
	...
	public void testAddNewColumnsToSingleColumnIndex() {
		...
		assertColumn("COL1", Types.INTEGER, null, null, false, false, false,
				colChange1.getNewColumn());
		assertEquals("ColPK", colChange1.getPreviousColumn());
		assertEquals("COL3", colChange1.getNextColumn());

		assertEquals("TableA", colChange2.getChangedTable());
		assertColumn("COL2", Types.DOUBLE, null, null, false, false, false,
				colChange2.getNewColumn());
		assertEquals("COL1", colChange2.getPreviousColumn());
		assertEquals("COL3", colChange2.getNextColumn());
	...
	/**
	 * Tests the addition and removal of an index because of the change of
	 * column order.
	 */
	...
	/**
	 * Tests the recreation of an index because of the addition of an index
	 * column.
	 */
	...
	/**
	 * Tests the addition and removal of an index because of the removal of an
	 * index column.
	 */
	...
	public void testDropColumnFromSingleColumnIndex() {
		...
		assertEquals("TableA", colChange.getChangedTable());
		assertEquals("COL1", colChange.getChangedColumn());
	}
	...
	public void testDropColumnFromMultiColumnIndex() {
		...
		assertEquals("TableA", colChange.getChangedTable());
		assertEquals("COL2", colChange.getChangedColumn());
	...
	/**
	 * Tests the addition of a column and changing the order of the columns in
	 * an index.
	 */
	...
	/**
	 * Tests the removal of a column and changing the order of the columns in an
	 * index.
	 */
	...
	/**
	 * Tests the recreation of an index because of the change of type of the
	 * index.
	 */
