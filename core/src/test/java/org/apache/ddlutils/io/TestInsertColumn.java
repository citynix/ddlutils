...
public class TestInsertColumn extends TestAgainstLiveDatabaseBase {
	...
	public void testInsertAutoIncrementColumn() {
		...
		// we need special catering for Sybase which does not support identity
		// for INTEGER columns
		boolean isSybase = SybasePlatform.DATABASENAME.equals(getPlatform()
				.getName());
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	...
	/**
	 * Tests the insert of a column with a default value. Note that depending on
	 * whether the database supports this via a statement, this test may fail.
	...
	public void testInsertColumnWithDefault() {
		...
		// we cannot be sure whether the default algorithm is used (which will
		// apply the
		// default value even to existing columns with NULL in it) or the
		// database supports
	 ...
	 * fail. For instance, Sql Server has a statement for this which means that
	 * the existing value in column avalue won't be changed and thus the test
	 * fails.
	 */
	...
	/**
	 * Tests the insertion of a non-unique index and a column with a default
	 * value.
	 */
	...
	/**
	 * Tests the insertion of a non-unique index and a required auto increment
	 * column.
	 */
	...
	/**
	 * Tests the insertion of a non-unique index and a required column with a
	 * default value.
	 */
	...
	/**
	 * Tests the insertion of an unique index and a required auto increment
	 * column.
	 */
	...
	/**
	 * Tests the insertion of an unique index and a required column with a
	 * default value.
	 */
	...
	/**
	 * Tests the insertion of a column with a default value into a non-unique
	 * index.
	 */
	...
	/**
	 * Tests the insertion of a required auto increment column into a non-unique
	 * index.
	 */
	...
	/**
	 * Tests the insertion of a required column with a default value into a
	 * non-unique index.
	 */
	...
	/**
	 * Tests the insertion of a column with a default value into an unique
	 * index.
	 */
	...
	/**
	 * Tests the insertion of a required auto increment column into an unique
	 * index.
	 */
	...
	/**
	 * Tests the insertion of a required column with a default value into an
	 * unique index.
	 */
	...
	/**
	 * Tests the insertion of a foreign key and its local column with a default
	 * value.
	 */
	...
	/**
	 * Tests the insertion of a foreign key and its local required auto
	 * increment column.
	 */
	...
	/**
	 * Tests the insertion of a foreign key and its local required column with a
	 * default value.
	 */
	...
	public void testInsertFKAndForeignColumn() {
		...
		createDatabase(model1Xml);
		// no point trying this with data in the db as it will only cause a
	...
	/**
	 * Tests the insertion of a foreign key and its foreign auto increment
	 * column.
	 */
	...
	/**
	 * Tests the insertion of local and foreign auto increment columns into a
	 * foreign key.
	 */
	...
	/**
	 * Tests the insertion of local and foreign required columns into a foreign
	 * key.
	 */
	...
	/**
	 * Tests the insertion of local and foreign columns with default values into
	 * a foreign key.
	 */
	...
	/**
	 * Tests the insertion of local and foreign required auto increment columns
	 * into a foreign key.
	 */
	...
	/**
	 * Tests the insertion of local and foreign required columns with default
	 * values into a foreign key.
	 */
	...
	/**
	 * Tests the insertion of multiple local and foreign columns into a foreign
	 * key.
	 */
