 ...
 * 
 * TODO: - more type conversion tests (parameterized ?) - more size change tests
 * (parameterized ?)
 * 
 * @version $Revision: $
 */
public class TestChangeColumn extends TestAgainstLiveDatabaseBase {
	...
	// - for each of the above: normal column, pk column, fk column (local),
	// index column, unique index column
	...
	/**
	 * Tests the alteration of a column datatype change from smallint to
	 * varchar.
	 */
	public void testColumnTypeSmallintToVarchar() {
		...
		// Some databases (e.g. DB2) pad the string for some reason, so we
		// manually trim it
	...
	/**
	 * Tests the alteration of a pk column datatype change from integer to
	 * double.
	 */
	...
	/**
	 * Tests the change of the datatypes of PK and FK columns from integer to
	 * varchar.
	 */
	...
	/**
	 * Tests the alteration of the datatypes of columns of a PK and FK that will
	 * be dropped.
	 */
	...
	/**
	 * Tests the alteration of an indexed column datatype change from integer to
	 * double.
	 */
	...
	/**
	 * Tests the alteration of an indexed column datatype change from smallint
	 * to varchar.
	 */
	public void testIndexColumnTypeSmallintToVarchar() {
		...
		insertRow("roundtrip", new Object[]{new Integer(1),
				new Short((short) 2), new Double(3.0)});
	...
	/**
	 * Tests the alteration of the datatype of an indexed column where the index
	 * will be dropped.
	 */
	...
	public void testColumnDecreaseSize() {
		...
		assertTrue("12345678901234567890123456789012"
				.equals(bean.get("avalue"))
	...
	public void testIndexColumnIncreasePrecision() {
		...
		insertRow("roundtrip", new Object[]{new Integer(1),
				new BigDecimal("123456.12"), new Integer(2)});
	...
	public void testPKColumnIncreaseScale() {
		...
		// Some DBs return the BigDecimal with the three digits scale, some
		// don't
	...
	public void testPKColumnRemoveDefault() {
		...
		assertTrue(bean.get("pk").equals(new BigDecimal("2"))
				|| bean.get("pk").equals(new BigDecimal("2.00")));
	...
	public void testPKAndFKColumnAddDefault() {
		...
		insertRow("roundtrip1", new Object[]{new BigDecimal("0"),
				new Integer(1)});
		insertRow("roundtrip2", new Object[]{new Integer(1),
				new BigDecimal("0")});
	...
	public void testIndexColumnRemoveDefault() {
		...
		insertRow("roundtrip", new Object[]{new Integer(2), "test",
				new BigDecimal("4")});
	...
	public void testUniqueIndexColumnRemoveDefault() {
		...
		insertRow("roundtrip", new Object[]{new Integer(2), new Integer(4),
				"test"});
