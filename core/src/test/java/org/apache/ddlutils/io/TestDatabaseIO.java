...
/**
 * Tests the database XML reading/writing via the
 * {@link org.apache.ddlutils.io.DatabaseIO} class.
 * 
...
public class TestDatabaseIO extends TestCase {
	 ...
	 * @param numPrimaryKeyColumns
	 *            The expected number of primary key columns
	 * @param numAutoIncrementColumns
	 *            The expected number of auto increment columns
	 * @param numForeignKeys
	 *            The expected number of foreign keys
	 * @param numIndexes
	 *            The expected number of indexes
	 * @param table
	 *            The table
	 */
	private void assertEquals(String name, String description, int numColumns,
			int numPrimaryKeyColumns, int numAutoIncrementColumns,
			int numForeignKeys, int numIndexes, Table table) {
		...
		assertEquals(numAutoIncrementColumns,
				table.getAutoIncrementColumns().length);
	 ...
	 *            The expected description
	 * @param javaName
	 *            The expected java name
	 * @param isPrimaryKey
	 *            The expected primary key status
	 * @param isRequired
	 *            The expected required satus
	 * @param isAutoIncrement
	 *            The expected auto increment status
	 * @param column
	 *            The column
	 */
	private void assertEquals(String name, int typeCode, int size, int scale,
			String defaultValue, String description, String javaName,
			boolean isPrimaryKey, boolean isRequired, boolean isAutoIncrement,
			Column column) {
	 ...
	 *            The expected name
	 * @param onUpdate
	 *            The expected onUpdate action
	 * @param onDelete
	 *            The expected onDelete action
	 * @param referencedTable
	 *            The expected referenced table
	 * @param numReferences
	 *            The expected number of references
	 * @param foreignKey
	 *            The foreign key
	 */
	private void assertEquals(String name, CascadeActionEnum onUpdate,
			CascadeActionEnum onDelete, Table referencedTable,
			int numReferences, ForeignKey foreignKey) {
		...
		assertEquals(referencedTable.getName(),
	 ...
	 * 
	 * @param localColumn
	 *            The expected local column
	 * @param foreignColumn
	 *            The expected foreign column
	 * @param ref
	 *            The reference
	 */
	private void assertEquals(Column localColumn, Column foreignColumn,
			Reference ref) {
	 ...
	 *            The expected name
	 * @param isUnique
	 *            The expected unique status
	 * @param numColumns
	 *            The expected number of columns
	 * @param index
	 *            The index
	 */
	private void assertEquals(String name, boolean isUnique, int numColumns,
			Index index) {
	 ...
	 *            The index column
	 */
	private void assertEquals(Column column, String size,
	...
	/**
	 * Asserts that the given database model, written to XML, is equal to the
	 * given expected XML.
	 * 
	 * @param expectedXml
	 *            The expected XML
	...
	public void testNoDatabaseElement() {
		try {
			readModel("<data-base xmlns='" + DatabaseIO.DDLUTILS_NAMESPACE
					+ "'></data-base>");
	...
	/**
	 * Tests that an exception is generated by the validation when the database
	 * element has no namespace attribute.
	 */
	...
	/**
	 * Tests that an exception is generated when the database element has no
	 * name attribute.
	 */
	public void testDatabaseWithoutName() {
		try {
			readModel("<database xmlns='" + DatabaseIO.DDLUTILS_NAMESPACE
	...
	public void testNoTables() throws Exception {
		Database model = readModel("<database xmlns='"
	...
	/**
	 * Tests that an exception is generated when the table element has no name
	 * attribute.
	 */
	...
	public void testSingleColumn() throws Exception {
		...
		assertEquals("ID", Types.INTEGER, 0, 0, null, null, null, false, false,
				false, table.getColumn(0));

		assertEquals(
				"<?xml version='1.0' encoding='UTF-8'?>\n"
						+ "<database xmlns=\""
						+ DatabaseIO.DDLUTILS_NAMESPACE
						+ "\" name=\"test\">\n"
						+ "  <table name=\"SomeTable\" description=\"Some table\">\n"
	...
	/**
	 * Tests that an exception is generated when the column element has no name
	 * attribute.
	 */
	...
	/**
	 * Tests that an exception is generated when the column element has no type
	 * attribute.
	 */
	...
	public void testColumnTypes() throws Exception {
		...
		modelXml.append("<database xmlns='" + DatabaseIO.DDLUTILS_NAMESPACE
				+ "' name='test'>\n");
		...
		for (int idx = 0; idx < types.length; idx++) {
			assertEquals("ID" + idx, types[idx], 0, 0, null, null, null, false,
					false, false, table.getColumn(idx));
		}
	...
	public void testPrimaryKeyColumn() throws Exception {
		...
		assertEquals("ID", Types.INTEGER, 0, 0, null, null, null, true, false,
				false, column);
	...
	public void testRequiredColumn() throws Exception {
		...
		assertEquals("SomeTable", "Some table", 1, 0, 0, 0, 0, table);
		assertEquals("ID", Types.INTEGER, 0, 0, null, null, null, false, true,
				false, table.getColumn(0));
	...
	public void testColumnWithSize1() throws Exception {
		...
		assertEquals("SomeTable", "Some table", 1, 0, 0, 0, 0, table);
		assertEquals("ID", Types.VARCHAR, 20, 0, null, null, null, false,
				false, false, table.getColumn(0));
	...
	public void testColumnWithSize2() throws Exception {
		...
		assertEquals("SomeTable", "Some table", 1, 0, 0, 0, 0, table);
		assertEquals("ID", Types.DECIMAL, 10, 3, null, null, null, false,
				false, false, table.getColumn(0));
	...
	public void testColumnWithDescription() throws Exception {
		...
		assertEquals("SomeTable", "Some table", 1, 0, 0, 0, 0, table);
		assertEquals("ID", Types.INTEGER, 0, 0, null, "Foo", null, false,
				false, false, table.getColumn(0));
	...
	public void testColumnWithDefault() throws Exception {
		...
		assertEquals("SomeTable", "Some table", 1, 0, 0, 0, 0, table);
		assertEquals("ID", Types.VARCHAR, 32, 0, "Test string", null, null,
				false, false, false, table.getColumn(0));
	...
	public void testColumnWithJavaName() throws Exception {
		...
		assertEquals("SomeTable", "Some table", 1, 0, 0, 0, 0, table);
		assertEquals("ID", Types.DOUBLE, 0, 0, null, null, "testString", false,
				false, false, table.getColumn(0));
	...
	public void testSingleForeignkey() throws Exception {
		...
		assertEquals("ID", Types.VARCHAR, 16, 0, null, "The primary key", null,
				true, true, false, pkColumn);
		...
		assertEquals("Some_ID", Types.VARCHAR, 16, 0, null, "The foreign key",
				null, false, false, false, fkColumn);

		ForeignKey fk = anotherTable.getForeignKey(0);

		assertEquals(null, CascadeActionEnum.NONE, CascadeActionEnum.NONE,
				someTable, 1, fk);
	...
	public void testForeignkeyWithTwoReferences() throws Exception {
		...
		assertEquals("ID", Types.VARCHAR, 16, 0, null, "The primary key", null,
				true, true, false, someTable.getColumn(0));
		...
		assertEquals("AnotherTable", "And another table", 2, 0, 0, 1, 0,
				anotherTable);
		assertEquals("Some_ID", Types.VARCHAR, 16, 0, null, "The foreign key",
				null, false, false, false, anotherTable.getColumn(0));
		...
		assertEquals(anotherTable.getColumn(0), someTable.getColumn(0),
				fk.getReference(0));
		assertEquals(anotherTable.getColumn(1), someTable.getColumn(2),
				fk.getReference(1));
	...
	public void testNamedForeignkey() throws Exception {
		...
		assertEquals("The foreignkey", CascadeActionEnum.NONE,
	...
	public void testForeignkeysWithOnUpdate() throws Exception {
		...
		assertEquals("AnotherTable", "And another table", 1, 0, 0,
				CascadeActionEnum.getEnumList().size(), 0, anotherTable);
		assertEquals("Some_ID", Types.VARCHAR, 16, 0, null, "The foreign key",
				null, false, false, false, anotherTable.getColumn(0));
	...
	/**
	 * Tests a foreign key referencing a non-existing column in the foreign
	 * table.
	 */
	...
	public void testSingleIndex() throws Exception {
		...
		assertEquals("id", Types.DOUBLE, 0, 0, null, null, null, true, true,
				false, table.getColumn(0));
		assertEquals("value", Types.SMALLINT, 0, 0, "1", null, null, false,
	...
	public void testIndexWithTwoColumns() throws Exception {
		...
		assertEquals("id", Types.DOUBLE, 0, 0, null, null, null, true, true,
				false, table.getColumn(0));
		assertEquals("when", Types.TIMESTAMP, 0, 0, null, null, null, false,
				true, false, table.getColumn(1));
		assertEquals("value", Types.SMALLINT, 0, 0, "1", null, null, false,
				false, false, table.getColumn(2));
	...
	/**
	 * Tests a database model with an index with an index column that references
	 * an undefined column.
	 */
	...
	/**
	 * Tests a database model with an index with an index column that has no
	 * name.
	 */
	...
	/**
	 * Tests a database model with an unique index with an index column that has
	 * no name.
	 */
	...
	public void testMixedIndexes() throws Exception {
		...
		assertEquals("id", Types.SMALLINT, 0, 0, null, null, null, false, true,
				true, table.getColumn(0));
		assertEquals("when", Types.DATE, 0, 0, null, null, null, false, false,
				false, table.getColumn(1));
	...
	/**
	 * Tests a complex database model with multiple tables, foreign keys,
	 * indices and uniques.
	 */
	public void testComplex() throws Exception {
		// A = id:INTEGER, parentId:INTEGER, name:VARCHAR(32); fk 'parent' -> A
		// (parentId -> id), unique(name)
		// B = id:TIMESTAMP, aid:INTEGER, cid:CHAR(32) fk -> A (aid -> id), fk
		// -> C (cid -> id), index(aid,cid)
		...
		assertEquals("id", Types.INTEGER, 0, 0, null,
				"The primary key of table A", null, true, true, true,
				table.getColumn(0));
		assertEquals("parentId", Types.INTEGER, 0, 0, null,
				"The field for the foreign key parent", null, false, false,
				false, table.getColumn(1));
		assertEquals("name", Types.VARCHAR, 32, 0, null, "The name", null,
				false, true, false, table.getColumn(2));
		assertEquals(table.getColumn(0), table.getAutoIncrementColumns()[0]);

		ForeignKey fk = table.getForeignKey(0);

		assertEquals("parent", CascadeActionEnum.NONE, CascadeActionEnum.NONE,
				table, 1, fk);
		assertEquals(table.getColumn(1), table.getColumn(0),
				fk.getFirstReference());
		...
		assertEquals("id", Types.TIMESTAMP, 0, 0, null,
				"The primary key of table B", null, true, true, false,
				table.getColumn(0));
		assertEquals("aid", Types.INTEGER, 0, 0, null,
				"The field for the foreign key towards A", null, false, false,
				false, table.getColumn(1));
		assertEquals("cid", Types.CHAR, 32, 0, null,
				"The field for the foreign key towards C", null, false, false,
				false, table.getColumn(2));

		fk = table.getForeignKey(0);

		assertEquals(null, CascadeActionEnum.NONE, CascadeActionEnum.NONE,
				model.getTable(0), 1, fk);
		assertEquals(table.getColumn(1), model.getTable(0).getColumn(0),
				fk.getFirstReference());

		fk = table.getForeignKey(1);

		assertEquals(null, CascadeActionEnum.NONE, CascadeActionEnum.NONE,
				model.getTable(2), 1, fk);
		assertEquals(table.getColumn(2), model.getTable(2).getColumn(0),
				fk.getFirstReference());
		...
		assertEquals("id", Types.CHAR, 32, 0, null,
				"The primary key of table C", null, true, true, false,
				table.getColumn(0));
		assertEquals("text", Types.LONGVARCHAR, 0, 0, null, "The text", null,
				false, false, false, table.getColumn(1));
	...
	/**
	 * Tests that an exception is generated when an index references an
	 * undefined column.
	 */
	...
	/**
	 * Tests that an exception is generated when two table elements have the
	...
	/**
	 * Tests that an exception is generated when two column elements within the
	 * same table element have the same value in their name attributes.
	 */
	...
	/**
	 * Tests that an exception is generated when the a unique index references
	 * an undefined column.
	 */
	...
	/**
	 * Tests that an exception is generated when two indices have the same value
	...
	/**
	 * Regression test ensuring that wrong XML is not read (regarding betwixt
	 * issue #37369).
	 */
	...
	public void testTurbineExtension() throws Exception {
		...
		assertEquals("intField", Types.TINYINT, 0, 0, null, null, null, false,
				false, false, table.getColumn(0));
		assertEquals("charField", Types.CHAR, 0, 0, null, null, null, false,
				false, false, table.getColumn(1));
