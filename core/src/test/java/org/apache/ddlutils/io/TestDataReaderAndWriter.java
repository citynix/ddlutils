...
/**
 * Tests the {@link org.apache.ddlutils.io.DataReader} and
 * {@link org.apache.ddlutils.io.DataWriter} classes.
 * 
 * @version $Revision: 289996 $
 */
public class TestDataReaderAndWriter extends TestCase {
	/**
	 * A test data sink. There is no need to call start/end as the don't do
	 * anything anyways in this class.
	 */
	private static class TestDataSink implements DataSink {
		...
		/**
		 * Creates a new test data sink using the given list as the backing
		 * store.
		 * 
		 * @param readObjects
		 *            The list to store the read object
		 */
	...
	/**
	 * Writes the given dyna bean via a {@link DataWriter} and returns the raw
	 * xml output.
	 * 
	 * @param model
	 ...
	 *            The bean to write
	 * @param encoding
	 *            The encoding in which to write the xml
	...
	/**
	 * Uses a {@link DataReader} with default settings to read dyna beans from
	 * the given xml data.
	 * 
	 * @param model
	 *            The database model to use
	...
	/**
	 * Helper method to perform a test that writes a bean and then reads it
	 * back.
	 * 
	 * @param model
	 *            The database model to use
	 ...
	 */
	private void roundtripTest(Database model, SqlDynaBean bean,
			String encoding, String expectedDataXml)
	...
	public void testRead() throws Exception {
		...
		assertEquals("1952-01-01", obj3.get("issue_date").toString()); // parsed
																		// as a
																		// java.sql.Date
		...
		assertEquals("1606-01-01", obj4.get("issue_date").toString()); // parsed
																		// as a
																		// java.sql.Date
		...
		assertEquals("1595-01-01", obj5.get("issue_date").toString()); // parsed
																		// as a
																		// java.sql.Date
	}
	...
	public void testRootElementNameDoesntMatter() throws Exception {
		Database model = readModel("<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				...
				+ "    <column name='value' type='VARCHAR' size='50' required='true'/>\n"
				+ "  </table>\n" + "</database>");
		List beans = readBeans(model, "<someRandomName>\n"
				+ "  <test id='1' value='foo'/>\n" + "</someRandomName>");
	...
	public void testSpecialCharacters() throws Exception {
		...
		SqlDynaBean bean = (SqlDynaBean) model.createDynaBeanFor(model
				.getTable(0));
		...
		roundtripTest(
				...
				"<?xml version='1.0' encoding='ISO-8859-1'?>\n"
						...
						+ "  <test id=\"1\">\n"
						+ "    <value "
						+ DatabaseIO.BASE64_ATTR_NAME
						+ "=\"true\">"
						+ new String(Base64.encodeBase64(testedValue
	...
	public void testTableNameNotAValidXmlIdentifier() throws Exception {
		...
		roundtripTest(model, bean, "UTF-8",
				"<?xml version='1.0' encoding='UTF-8'?>\n" + "<data>\n"
						+ "  <table table-name=\"test$\" id=\"1\" value=\""
						+ testedValue + "\" />\n" + "</data>\n");
	}
	...
	public void testTableNameContainsAmpersand() throws Exception {
		...
		roundtripTest(
				...
				"<?xml version='1.0' encoding='UTF-8'?>\n"
						+ "<data>\n"
						+ "  <table table-name=\"test&amp;table\" id=\"1\" value=\""
						+ testedValue + "\" />\n" + "</data>\n");
	}
...
/**
	...
	/**
	 * Tests the reader & writer behavior when the table name contains
	...
	public void testTableNameContainsInvalidCharacters() throws Exception {
		...
		roundtripTest(
				...
				"<?xml version='1.0' encoding='UTF-8'?>\n"
						...
						+ DatabaseIO.BASE64_ATTR_NAME
						+ "=\"true\">"
						+ new String(Base64.encodeBase64(tableName
	...
	public void testTableNameIsTable() throws Exception {
		...
		roundtripTest(model, bean, "UTF-8",
				"<?xml version='1.0' encoding='UTF-8'?>\n" + "<data>\n"
						+ "  <table table-name=\"table\" id=\"1\" value=\""
						+ testedValue + "\" />\n" + "</data>\n");
	}

	/**
	 * Tests the reader & writer behavior when a column name is a normal valid
	 * tag, and both column name and value are shorter than 255 characters.
	 */
	...
	/**
	 * Tests the reader & writer behavior when a column name is a normal valid
	 * tag, and the column name is shorter than 255 characters but the value is
	 * longer.
	 */
	 ...
	 * and the column name is shorter than 255 characters and the value is
	 * longer.
	 */
	 ...
	 * the column name is longer than 255 characters and the value is shorter.
	 */
	...
	public void testColumnNameLongAndValueLong() throws Exception {
		...
		Database model = readModel("<?xml version='1.0' encoding='UTF-8'?>\n"
				...
				+ "    <column name='id' type='INTEGER' primaryKey='true' required='true'/>\n"
				+ "    <column name='" + columnName
				+ "' type='VARCHAR' size='500' required='true'/>\n"
				+ "  </table>\n" + "</database>");
		String testedValue = StringUtils.repeat("Some Text", 40);
	...
	public void testColumnNameAndValueShortAndInvalid() throws Exception {
		...
		roundtripTest(
				...
				"<?xml version='1.0' encoding='UTF-8'?>\n"
						...
						+ "=\"true\">"
						+ new String(Base64.encodeBase64(testedValue
								.getBytes("UTF-8")), "UTF-8") + "</column>\n"
						+ "  </test>\n" + "</data>\n");
	}

	/**
	 * Tests the reader & writer behavior when a column name is a valid tag and
	 * longer, than 255 characters, and the value is invalid and shorter than
	 * 255 characters.
	 */
	...
	public void testColumnNameAndValueLongAndInvalid() throws Exception {
		...
		roundtripTest(
				...
				"<?xml version='1.0' encoding='UTF-8'?>\n"
						...
						+ DatabaseIO.BASE64_ATTR_NAME
						+ "=\"true\">"
						+ new String(Base64.encodeBase64(columnName
								.getBytes("UTF-8")), "UTF-8")
						+ "</column-name>\n"
						+ "      <column-value "
						+ DatabaseIO.BASE64_ATTR_NAME
	...
	/**
	 * Tests the reader & writer behavior when a column value contains an
	 * invalid character.
	 */
...
/**
	...
	public void testColumnValueContainsMoreCharacter() throws Exception {
		...
		roundtripTest(model, bean, "UTF-8",
				"<?xml version='1.0' encoding='UTF-8'?>\n" + "<data>\n"
						+ "  <test id=\"1\">\n"
						+ "    <column column-name=\"foo>bar\">" + testedValue
						+ "</column>\n" + "  </test>\n" + "</data>\n");
	}
	...
	public void testColumnNameIsBase64() throws Exception {
		Database model = readModel("<?xml version='1.0' encoding='UTF-8'?>\n"
				...
				+ "  <table name='test'>\n"
				+ "    <column name='id' type='INTEGER' primaryKey='true' required='true'/>\n"
				+ "    <column name='" + DatabaseIO.BASE64_ATTR_NAME
				+ "' type='VARCHAR' size='50' required='true'/>\n"
				+ "  </table>\n" + "</database>");
		String testedValue = "Some Text";
		...
		roundtripTest(model, bean, "UTF-8",
				"<?xml version='1.0' encoding='UTF-8'?>\n" + "<data>\n"
						+ "  <test id=\"1\">\n" + "    <column column-name=\""
						+ DatabaseIO.BASE64_ATTR_NAME + "\">" + testedValue
						+ "</column>\n" + "  </test>\n" + "</data>\n");
	}
}
