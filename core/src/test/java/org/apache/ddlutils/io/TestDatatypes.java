...
public class TestDatatypes extends TestAgainstLiveDatabaseBase {
	 ...
	 *            The model as XML
	 * @param value1
	 *            The non-pk value for the first row
	 * @param value2
	 *            The non-pk value for the second row
	 */
	protected void performDataTypeTest(String modelXml, Object value1,
			Object value2) {
	 ...
	 *            The model as XML
	 * @param value1
	 *            The non-pk value for the first row; use <code>null</code> for
	 *            the default value
	 * @param value2
	 *            The non-pk value for the second row; use <code>null</code> for
	 *            the default value
	 * @param defaultValue
	 *            The default value
	 */
	protected void performDataTypeTest(String modelXml, Object value1,
			Object value2, Object defaultValue) {
		performDataTypeTest(modelXml, value1, value2, value1 == null
				? defaultValue
				: value1, value2 == null ? defaultValue : value2);
	}

	/**
	 * Performs a data type test. In short, we're testing creation of a
	 * database, insertion of values into it, and reading the model back. In
	 * addition we also check that DdlUtils does not try to alter the new
	 * database when using the <code>alterTables</code>/
	 * <code>getAlterTablesSql</code> methods of the
	 * {@link org.apache.ddlutils.Platform} with the read-back model.
	 * 
	 * @param modelXml
	 *            The model as XML
	 * @param inserted1
	 *            The non-pk value to insert for the first row
	 * @param inserted2
	 *            The non-pk value to insert for the second row
	 * @param expected1
	 *            The expected non-pk value for the first row
	 * @param expected2
	 *            The expected non-pk value for the second row
	 */
	protected void performDataTypeTest(String modelXml, Object inserted1,
			Object inserted2, Object expected1, Object expected2) {
		...
		dataIO.writeDataToDatabase(getPlatform(), getModel(),
				new Reader[]{new StringReader(dataSql)});
	...
	public void testSmallInt() {
		...
		performDataTypeTest(modelXml, new Integer(Short.MIN_VALUE),
	...
	public void testSmallIntWithDefault() {
		...
		performDataTypeTest(modelXml, new Integer(256), null, new Integer(
				-30000));
	}
	...
	public void testIntegerWithDefault() {
		...
		performDataTypeTest(modelXml, null, new Integer(2147483646),
	...
	public void testBigIntWithDefault() {
		...
		performDataTypeTest(modelXml, null, new Long(-1l), new Long(
	...
	public void testRealWithDefault() {
		...
		performDataTypeTest(modelXml, new Float(1e+20f), null, new Float(
				-1.01234f));
	}
	...
	public void testFloatWithDefault() {
		...
		performDataTypeTest(modelXml, null, new Double(1e+25), new Double(
				12345678.9012345));
	}
	...
	public void testDoubleWithDefault() {
		...
		performDataTypeTest(modelXml, new Double(-1e+25), null, new Double(
				-987654321.098765));
	}
	...
	public void testDecimal() {
		...
		performDataTypeTest(modelXml, new BigDecimal("0"), new BigDecimal(
				"-1234567890123"));
	}
	...
	public void testDecimalWithDefault() {
		...
		performDataTypeTest(modelXml, null, new BigDecimal("-1"),
	...
	public void testDecimalWithScale() {
		...
		performDataTypeTest(modelXml, new BigDecimal("0.0100001"),
				new BigDecimal("-87654321.1234567"));
	}
	...
	public void testDecimalWithScaleAndDefault() {
		...
		performDataTypeTest(modelXml, new BigDecimal("1.0000001"), null,
				new BigDecimal("12345678.7654321"));
	}
	...
	public void testNumeric() {
		...
		performDataTypeTest(modelXml, new BigDecimal("210987654321"),
				new BigDecimal("-2"));
	}
	...
	public void testNumericWithDefault() {
		...
		performDataTypeTest(modelXml, null, new BigDecimal("100"),
				new BigDecimal("-123456789012345"));
	}
	...
	public void testNumericWithScale() {
		...
		performDataTypeTest(modelXml, new BigDecimal("1234567.89012345"),
	...
	public void testNumericWithScaleAndDefault() {
		...
		performDataTypeTest(modelXml, null, new BigDecimal("1e-8"),
	...
	public void testCharWithDefault() {
		...
		performDataTypeTest(modelXml, null, "123456789012345",
				"543210987654321", "123456789012345");
	}
	...
	public void testVarCharWithDefault() {
		final String modelXml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				...
				+ "  </table>\n" + "</database>";
		final String value = "1234567890123456789012345678901234567890123456789012345678901234"
	...
	public void testDateWithDefault() {
		...
		// we would use Calendar but that might give Locale problems
		performDataTypeTest(modelXml, new Date(105, 0, 1), null, new Date(100,
				0, 1));
	}
	...
	public void testTimeWithDefault() {
		...
		// we would use Calendar but that might give Locale problems
		performDataTypeTest(modelXml, new Time(23, 59, 59), null, new Time(11,
				27, 03));
	}
	...
	public void testTimestamp() {
		...
		performDataTypeTest(modelXml, new Timestamp(70, 0, 1, 0, 0, 0, 0),
				new Timestamp(100, 10, 11, 10, 10, 10, 0));
	}
	...
	public void testTimestampWithDefault() {
		...
		// also we leave out the fractional part because databases differ
		// in their support here
		performDataTypeTest(modelXml, new Timestamp(90, 9, 21, 20, 25, 39, 0),
				null, new Timestamp(85, 5, 17, 16, 17, 18, 0));
	}
	...
	public void testBinary() {
		...
		performDataTypeTest(modelXml, helper.serialize(value1),
				helper.serialize(value2), value1, value2);
	}
	...
	public void testLongVarBinary() {
		...
		performDataTypeTest(modelXml, helper.serialize(value), null, value,
				null);
	}
