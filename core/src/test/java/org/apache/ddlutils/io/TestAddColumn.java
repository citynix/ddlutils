...
public class TestAddColumn extends TestAgainstLiveDatabaseBase {
	...
	/**
	 * Tests the addition of multiple columns into the primary key which has an
	...
	/**
	 * Tests the addition of multiple columns including one with auto increment
	...
	/**
	 * Tests the addition of a non-unique index and a column with a default
	 * value.
	 */
	...
	/**
	 * Tests the addition of a non-unique index and a required column with a
	 * default value.
	 */
	...
	/**
	 * Tests the addition of an unique index and a required auto increment
	 * column.
	 */
	...
	/**
	 * Tests the addition of an unique index and a required column with a
	 * default value.
	 */
	...
	/**
	 * Tests the addition of a column with a default value into a non-unique
	 * index.
	 */
	...
	/**
	 * Tests the addition of a required auto increment column into an unique
	 * index.
	 */
	...
	/**
	 * Tests the addition of a required column with a default value into an
	 * unique index.
	 */
	...
	public void testAddFKAndLocalRequiredColumn() {
		...
		if (MySqlPlatform.DATABASENAME.equals(getPlatform().getName())
			...
			// MySql does not allow adding a required column to a fk without a
			// default value
			return;
		}
	...
	/**
	 * Tests the addition of a foreign key and its foreign auto increment
	 * column.
	 */
	...
	/**
	 * Tests the addition of local and foreign auto increment columns into a
	 * foreign key.
	 */
	...
	/**
	 * Tests the addition of local and foreign required columns into a foreign
	 * key.
	 */
	...
	/**
	 * Tests the addition of local and foreign columns with default values into
	 * a foreign key.
	 */
	...
	/**
	 * Tests the addition of local and foreign required auto increment columns
	 * into a foreign key.
	 */
	...
	/**
	 * Tests the addition of local and foreign required columns with default
	...
	/**
	 * Tests the addition of multiple local and foreign columns into a foreign
	 * key.
	 */
