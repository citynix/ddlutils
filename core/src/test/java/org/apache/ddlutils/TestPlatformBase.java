...
public abstract class TestPlatformBase extends TestBase {
	...
	protected void setUp() throws Exception {
		...
		_platform = PlatformFactory
				.createNewPlatformInstance(getDatabaseName());
	...
	/**
	 * Returns the SQL to create the test database for the table-level
	 * constraint tests.
	 * 
	 * @return The SQL
	 */
	protected String getTableConstraintTestDatabaseCreationSql()
			throws IOException {
		final String schema = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
				+ "' name='tableconstraintstest'>\n"
				+ "  <table name='table1'>\n"
	...
	/**
	 * Returns the SQL to create the test database for testing character
	 * escaping.
	 * 
	 * @return The SQL
	 */
	protected String getCharEscapingTestDatabaseCreationSql()
			throws IOException {
		final String schema = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
