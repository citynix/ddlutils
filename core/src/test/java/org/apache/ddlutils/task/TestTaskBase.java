...
public abstract class TestTaskBase extends TestAgainstLiveDatabaseBase {
	/**
	 * Returns an instance of the {@link DatabaseToDdlTask}, already configured
	 * with a project and the tested database.
	 * 
	...
	/**
	 * Returns an instance of the {@link DdlToDatabaseTask}, already configured
	 * with a project and the tested database.
	 * 
	 * @return The task object
	 */
