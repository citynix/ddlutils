...
public class TestWriteSchemaToFileCommand extends TestTaskBase {
	...
	/**
	 * Adds the writeSchemaToFile sub task to the given task, executes it, and
	 * checks its output.
	 * 
	 * @param task
	 *            The task
	 ...
	 *            The expected model
	 */
	private void runTask(DatabaseToDdlTask task, Database expectedModel)
			throws IOException {
		...
		try {
			...
			assertEquals(expectedModel, new DatabaseIO().read(tmpFile),
	...
	public void testSimpleModel() throws IOException {
		...
		runTask(getDatabaseToDdlTaskInstance(),
	...
	/**
	 * Tests of the includeTables filter in the presence of a foreign key to the
	 * indicated table.
	 */
	...
	/**
	 * Tests of the includeTableFilter filter in the presence of a foreign key
	 ...
	 * Tests of the includeTables filter for multiple tables.
	 */
	public void testIncludeMultipleTablesWithFKPointingToThem()
			throws IOException {
		final String modelXml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	 ...
	 */
	public void testIncludeMultipleTablesWithFKPointingToThemViaRegExp()
			throws IOException {
		final String modelXml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	...
	/**
	 * Tests of the excludeTables filter in the presence of a foreign key to the
	 * indicated table.
	 */
	...
	/**
	 * Tests of the excludeTableFilter filter in the presence of a foreign key
	 * to the indicated table.
	 */
	 ...
	 * Tests of the excludeTables filter for multiple tables.
	 */
	public void testExcludeMultipleTablesWithFKPointingToThem()
			throws IOException {
		final String modelXml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	 ...
	 */
	public void testExcludeMultipleTablesWithFKPointingToThemViaRegExp()
			throws IOException {
		final String modelXml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
	...
	/**
	 * Tests of the includeTableFilter and excludeTableFilter filters for
	 * multiple tables.
	 */
	public void testIncludeAndExcludeMultipleTablesViaRegExp()
			throws IOException {
		final String model1Xml = "<?xml version='1.0' encoding='ISO-8859-1'?>\n"
				+ "<database xmlns='"
				+ DatabaseIO.DDLUTILS_NAMESPACE
