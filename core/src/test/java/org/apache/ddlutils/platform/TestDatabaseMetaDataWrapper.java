...
public class TestDatabaseMetaDataWrapper extends TestBase {
	/**
	 * Helper method to create a proxied DatabaseMetaData instance using the
	 * given invocation handler.
	 * 
	 * @param handler
	 *            The handler
	 * @return The proxy object
	 */
	private DatabaseMetaData createMockDatabaseMetaData(
	...
	/**
	 * Tests the {@link DatabaseMetaDataWrapper#escapeForSearch(String)} method
	 * (see DDLUTILS-246).
	 */
