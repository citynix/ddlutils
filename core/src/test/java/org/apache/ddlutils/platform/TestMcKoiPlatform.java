...
public class TestMcKoiPlatform extends TestPlatformBase {
	...
	public void testColumnTypes() throws Exception {
		assertEqualsIgnoringWhitespaces("DROP TABLE IF EXISTS \"coltype\";\n"
	...
	public void testColumnConstraints() throws Exception {
		// note that this is not valid SQL as obviously only one auto increment
		// field
	...
	public void testTableConstraints() throws Exception {
		// The database schema for testing table constraints, ie. foreign keys
		// and indices.
		// This schema is adapted for McKoi which does not support non-unique
		// indices
