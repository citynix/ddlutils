...
public class TestMSSqlPlatform extends TestPlatformBase {
	...
	public void testColumnTypes() throws Exception {
		...
		Pattern declarePattern = Pattern
				.compile("DECLARE @([\\S]+) [^@]+@([\\S]+)");
	...
	public void testColumnConstraints() throws Exception {
		...
		// Note that this is not valid SQL as a table can have only one identity
		// column at most
		assertEqualsIgnoringWhitespaces(
				"SET quoted_identifier on;\n"
						+ "SET quoted_identifier on;\n"
	...
	/**
	 * Tests the proper escaping of character sequences where Sql Server
	 * requires it.
	 */
