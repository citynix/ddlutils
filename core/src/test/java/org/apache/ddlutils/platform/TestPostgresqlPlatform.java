...
public class TestPostgresqlPlatform extends TestPlatformBase {
	...
	public void testColumnTypes() throws Exception {
		assertEqualsIgnoringWhitespaces("DROP TABLE \"coltype\" CASCADE;\n"
	...
	/**
	 * Tests the proper escaping of character sequences where PostgreSQL
	 * requires it.
	 */
	public void testCharacterEscaping() throws Exception {
		// PostgreSql specific database schema for testing escaping of character
		// sequences
