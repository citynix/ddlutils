...
public class TestSqlBuilder extends TestBase {
	...
	public void testUpdateSql1() {
		...
		assertEquals(
				"UPDATE \"TestTable\" SET \"name\" = 'ddlutils' WHERE \"id\" = '0'",
				sql);
	}

	/**
	 * Tests the {@link SqlBuilder#getUpdateSql(Table, Map, Map, boolean)}
	 * method.
	 */
	public void testUpdateSql2() {
		...
		String sql = sqlBuilder.getUpdateSql(database.getTable(0), oldMap,
				newMap, false);

		assertEquals(
				"UPDATE \"TestTable\" SET \"id\" = '1', \"name\" = 'ddlutils' WHERE \"id\" = '0'",
				sql);
	}
}
